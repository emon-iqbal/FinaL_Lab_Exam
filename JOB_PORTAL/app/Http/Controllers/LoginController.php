...
class LoginController extends Controller
{
    ...
    function index(){
    	...
    	return view('login.index');    ///login folder, index.blade.php file
    }
    ...
    function verify(Request $request){
    	...
    	if(count($data) > 0 ){
            ...
            $request->session()->flash('msg', 'invalid username/password');     ///[[use line no. 32 for showing this error msg in >views>login>index.blade.php ]]
